        ...
        <div className="center px-6 py-4 ">
            <div className="w-full max-w-xs shadow-2xl">
                <form className="rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div className="mb-4">
                    <label className="block text-white text-base mb-2" htmlFor="username">
                        Username
                    </label>
                    ...
                    <button className="bg-purple-600 hover:bg-blue-800 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                        Sign In
                    </button>
                    <a className="inline-block align-baseline text-base text-white hover:text-blue-800" href="#">
                        Register
                    </a>
                    </div>
                </form>
